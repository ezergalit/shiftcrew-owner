...
export const STOPS = {
  ...
  "menu-group": ({ group }) => (group ? insideOf(group) : "הקטגוריות של התפריט הזה, וכמה מנות בכל אחת."),
  "menu-cat": ({ cat, items }) => {
  ...
  "menu-dish": ({ items }) => {
    ...
    return `כאן רואים ${seen}. «עריכת המנה» פותח את השדות, וכל שינוי מגיע אליהם מיד.`;
  },
  "menu-end": ({ cat }) => (cat
