...
//
// ⚠️ Duplicated in shiftcrew-waiter/src/lib/categoryVisual.js — change both together.
const RULES = [
  ...
  [/דג|fish|(^|\s)ים(\s|$)|seafood|פירות ה?ים/i, { emoji: "🐟", from: "#163a4f", to: "#38bdf8" }],
  ...
  [/שתי|drink|קפה|coffee|(^|\s)תה(\s|$)|מיץ|juice|שייק|smoothie/i, { emoji: "🥤", from: "#173a45", to: "#2dd4bf" }],
