...
const buildSteps = (teamCode) => [
  ...
  },
  {
    ...
    body: "חשוב לזכור — המשחקים הם רק האימון. המטרה היא שכל מלצר יעבור את מבחני הקטגוריות, ובסוף את מבחן התפריט המלא. אתם כותבים עדכון בבוקר ובודקים ב-📊 מי מתקדם; כל השאר קורה מעצמו. אפשר לחזור לסיור הזה בכל רגע דרך ההגדרות.",
  },
];
