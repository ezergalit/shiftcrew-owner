...
const buildSteps = (teamCode) => [
  ...
  },
  {
    ...
    body: "חשוב להבין: המשחקים הם רק האימון — המטרה היא שהצוות יעבור את המבחנים, ובסוף את מבחן התפריט המלא (כ-40 שאלות עם שעון). ״מי למד היום״ פתוח כאן תמיד: קודם מי שלמד, אחריו מי שנכנס ולא למד (הקבוצה שהכי שווה לשים לב אליה), ואחרון מי שלא נכנס. שורה אחת לכל אחד — ולחיצה על עובד פותחת עליו הכל: אחוז הידע, המנות שהוא טועה בהן, ציוני המבחנים וגרף השיפור.",
  },
  {
    tab: "home",
    title: "משימות המשמרת — מה הצוות רואה כרשימה",
    body: "בכרטיס ״משימות המשמרת״ בונים את מה שהצוות מסמן ליום: צ׳קליסט פתיחה, כללי שירות, צ׳קליסט סגירה ומשימות לימוד. לא צריך לכתוב — פותחים קבוצה, ״הוספה מהספרייה״ ומסמנים מה רלוונטי אצלכם. כל משימה ניתנת לעריכה, להסתרה זמנית (👁) ולסידור מחדש, וכמה עובדים סימנו אותה היום מופיע לידה.",
  },
  {
    tab: "settings",
