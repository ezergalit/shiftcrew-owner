...
const STEPS = [
  ...
  },
  {
    ...
    body: "כאן נמצאים פרטי המסעדה, קובעים מה חשוב לבחון (אלרגנים? מחירים? מרכיבים?), את סדר הקטגוריות בלימוד, את סף המעבר למבחן, ואת בוחן ההיכרות למלצר חדש. יש גם ״בדיקת בריאות תפריט״ שמוצאת מנות עם מידע חסר ומתקנת קבוצות שלמות במכה. שווה לעבור על זה עכשיו — הכל מאותחל להמלצה שלנו.",
  },
];
