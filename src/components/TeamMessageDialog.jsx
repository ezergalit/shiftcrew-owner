      ...
      >
        <div className="p-4 border-b border-[#22252b] flex items-center gap-3 flex-shrink-0">
          <div className="flex-1 min-w-0">
            <p className="text-base font-black text-[#eef0f6] truncate">הודעה ל{member.name}</p>
            <p className="text-[11px] text-[#8a8aa0]">ההודעה מופיעה רק אצלו/ה, לא לכל הצוות</p>
          </div>
        ...
        <div className="p-3 border-t border-[#22252b] flex-shrink-0 space-y-2 pb-[max(0.75rem,env(safe-area-inset-bottom))]">
          ...
          >
            <Send size={15} /> {busy ? "שולח…" : "שליחה באפליקציה"}
          </button>
